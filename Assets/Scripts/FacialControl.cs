...
{
    public GameObject still, happy, sad, disgust, happyEffect, sadEffect, disgustEffect;
    ...
    void Update()
    {
        if(_stillState){
            ...
            disgustEffect.SetActive(false);
            Tail_Animator.SetBool("happy", false);
            Tail_Animator.SetBool("sad", false);
            ...
            disgustEffect.SetActive(false);
            Tail_Animator.SetBool("happy", false);
            Tail_Animator.SetBool("sad", true);
            Tail_Animator.SetBool("disgust", false);
        }
